...
<body>
    <div class="main-content">
        <h1>Gestione di Ordini Accettati</h1>
        ...
        <div>
            <?php
                ...
                $query="SELECT DISTINCT `idUtente` 
                        ...
                        accettato = TRUE AND consegnato IS NULL;";
                ...
                if($result->num_rows>0){
                    while($row=$result->fetch_assoc()){
                        ...
                        if($resultUser->num_rows===1){
                            ...
                            echo "<div class='accept'>";
                                ...
                                echo "<form action='deliverOrder.php?idUser=$idUser' method='post'>";
                    ...
                    echo "<p >Non ci sono ordini accettati</p >";
